...
| Script                             | Purpose                         | Usage                   | Default Output            |
| ---------------------------------- | ------------------------------- | ----------------------- | ------------------------- |
| `./scripts/generate_test_cases.sh` | Create test cases interactively | Step-by-step prompts    | `ai-work/qa/test-plans/`  |
| `./scripts/create_bug_report.sh`   | Generate bug reports            | Guided input collection | `ai-work/qa/bug-reports/` |

Pass a path argument to override the default: `./scripts/generate_test_cases.sh path/to/output`

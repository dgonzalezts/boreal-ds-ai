...
**When to use:** A session revealed a gap, error, or new pattern in an existing instruction or guideline file (`copilot-instructions.md`, a `.github/instructions/*.md` file, or a `ai-docs/guidelines/` document).

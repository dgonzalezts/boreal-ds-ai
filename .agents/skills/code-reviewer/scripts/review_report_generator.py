...
class ReviewReportGenerator:
    ...
    def _render_markdown(self) -> str:
        ...
        lines += [
            ...
            "",
            "> _This section is completed by the agent after Phase 4 (consolidation) and Phase 5 "
            "(subagent validation, if dispatched). The script leaves this placeholder intentionally._",
            "",
            "<!-- CONSOLIDATED_FINDINGS_PLACEHOLDER -->",
            "",
            "---",
            "",

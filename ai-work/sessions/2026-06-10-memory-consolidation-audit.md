...
- `ai-docs/guidelines/code-practices-&-dev-guidelines.md`
...
| `component-interface-content-rule.md`                | partial   | promote then delete | `code-practices-&-dev-guidelines.md` §1.4 → new subsection "Component Interface Contract"                                                   | `stencil-component-knowledge` |
| `component-interface-file-naming.md`                 | partial   | promote then delete | `code-practices-&-dev-guidelines.md` §1.2 → naming conventions table                                                                        | `stencil-component-knowledge` |
...
| `feedback_event_options_explicit.md`                 | duplicate | delete              | `code-practices-&-dev-guidelines.md` §1.5 line ~1423 covers bubbles/composed for light DOM                                                  | `stencil-component-knowledge` |
| `feedback_prop_validation_pattern.md`                | duplicate | delete              | `code-practices-&-dev-guidelines.md` §1.4 "Property Validation" lines 1089–1140 covers full pattern + utility signature                     | `stencil-component-knowledge` |
...
| `stencil-form-control-interfaces.md`                 | partial   | promote then delete | `code-practices-&-dev-guidelines.md` §1.6 → add componentModels registration requirement                                                    | `stencil-component-knowledge` |
...
| `stencil-prop-patterns.md`                           | partial   | promote then delete | `code-practices-&-dev-guidelines.md` §1.4 → add mutable:true Stencil compiler warning; indexed access type ban; constant reference ban      | `stencil-component-knowledge` |
...
### `code-practices-&-dev-guidelines.md` (4 promotions)
